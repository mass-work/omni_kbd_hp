...
const UsageGuideVer010000: React.FC = () => {
  return (
    <Container>
      <Title>omni kbd 使い方 Ver01.00.00</Title>
      ...
      <Content>
        ...
        <Main>
          <Section id="keymap">
            ...
            <p>
              トラックボールの各操作は、キーマップ上の専用位置にキーコードを登録して変更できます。
              左右のトラックボールに異なる操作を設定することもできます。
            </p>

            <Subheading>スワイプ操作の設定</Subheading>
            <p>
              上・下・左・右のスワイプ操作に対応するキー入力をキーマップから設定できます。
              スワイプ操作はタッチキーモード内で使用します。
            </p>
          </Section>
            ...
            <Table>
              ...
              <tbody>
                ...
                <Trow>
                  ...
                  <Td>トラックボール操作に連動するハプティックフィードバックをON/OFFします。</Td>
                </Trow>
                <Trow>
                  <Td>HPT</Td>
                  <Td>Touch display haptic</Td>
                  <Td>タッチディスプレイ操作時のハプティックフィードバックをON/OFFします。</Td>
                </Trow>
                <Trow>
                  <Td>TOC</Td>
